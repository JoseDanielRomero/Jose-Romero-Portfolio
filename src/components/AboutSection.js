    ...
    <>
      <article className="h-auto w-full flex flex-col items-start justify-start gap-2">
        ...
        <section className="h-auto md:h-[400px] w-full flex flex-col md:flex-row gap-4">
          <div className="h-auto w-full md:h-full md:w-1/3">
            <p className="font-poppins text-base font-normal md:pr-10 text-slate-600">Since 2022 I am fully involved in <b>Software Development</b> and the IT world. I am also a <b>Dentist</b> by profession, a career which has given me immensely both personally and professionally. Being a healthcare personnel has given me a great capacity for <b>resolution</b> and <b>adaptability</b>.</p>
          </div>
          <div className="h-[300px] w-full bg-cover md:bg-auto md:h-full md:w-2/3 bg-right-top bg-no-repeat mb-5 md:mb-0" style={{backgroundImage: `url(${aboutmeImage})`}} />
        </section>
      </article>
      <article className="h-auto w-full flex flex-col items-start justify-start gap-2 md:gap-0">
        <h3 className="font-poppins font-bold text-[25px] md:text-[35px] leading-[2.3rem] md:leading-[55px] mt-5 md:mt-14 text-gray-800">Tech Stack</h3>
