      ...
      <article className="h-auto w-full flex flex-col items-start justify-start gap-2">
        ...
        <section className="h-auto md:h-[400px] w-full flex flex-col md:flex-row gap-4">
          <div className="h-auto w-full md:h-full md:w-1/2 lg:w-1/3 flex flex-col gap-3">
            <p className="font-poppins text-base font-normal md:pr-10 text-slate-600">Since 2022, I've been fully involved in <b>Software Development</b> and the IT world. I've had the opportunity to create software independently, I have also had the privilege of collaborating with companies and businesses to provide solutions as a <b>freelancer</b>.</p>
            <p className="font-poppins text-base font-normal md:pr-10 text-slate-600">In my free time when I'm not designing websites, I usually design smiles through dentistry.</p>
          </div>
